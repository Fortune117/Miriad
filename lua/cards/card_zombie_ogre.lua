...
CARD.health = 6 -- how much health the card has
CARD.maxHealth = 6 -- the regular max health a card has
CARD.mana 	= 4 -- how much mana it takes to summon the card
CARD.defaultMana = 4 -- how much mana it normally takes to summon the card
...
CARDS:register( "card_zombie_ogre", CARD, "card_minion_base" )
