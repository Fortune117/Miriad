...
BOARD.maxHandSize = 9
BOARD.startHandSize = 5
BOARD.player2BonusCards = 1
...
function BOARD:getNextTurn() -- get the opposite turns number
	return lume.pingpong( self:getTurn() - 1 ) + 1
end 
...
function BOARD:endTurn()
	...
	self:setTurn( self:getNextTurn() ) -- maths magic. should flip between 1 and 2
